...
<html>
    ...
    <body>
        <div class="container">
			...
			A opensourced passion project to replicate/mimmic the feel and customizability of 2008 MySpace. This is currently heavily under development, so expect some bugs or security bugs once in a while.<br><?php if(isset($_SESSION['siteusername'])): ?><br><a href="register.php"><button>Join</button><?php endif ?></a>
                    </div><br>
                    <div class="login">
